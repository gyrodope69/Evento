...
const NoteState = (props) => {
    ...
    const [notes, setNotes] = useState(notesInitial);
      //? Get everyones notes
      const everyNote = async () => {
        //~ Api call to get all notes
        const response = await fetch(`${host}/api/notes/everyonesnotes`, {
            method: 'GET',
            headers: {
    ...
    return (
        <NoteContext.Provider value={{ notes, addNote, deleteNote, editNote, getNote,everyNote }}>
            {props.children}
