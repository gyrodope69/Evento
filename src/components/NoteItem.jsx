            ...
            <div className='col-xxl-3 col-xl-4 col-lg-4 col-md-6'>
                <div className="card bg-light text-center my-4">
                    <div className="card-body">
                        ...
                        <hr />
                        <div className="mt-2">
                            <div className="text-center fw-bold"><span style={{ color: '#3C486B' }}>Evento</span></div>
                        </div>
                        <span className="position-absolute top-0 start-50 translate-middle text-wrap badge" style={{ backgroundColor: '#3C486B' }}>
                            {note.tag}
                        </span>
                    </div>
                </div>
